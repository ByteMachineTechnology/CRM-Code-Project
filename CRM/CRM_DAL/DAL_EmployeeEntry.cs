    ...
    public class DAL_EmployeeEntry
    {
        ...
        public int EmployeeEntry_Insert_Update_Delete(BAL_EmployeeEntry baemployee)
        {
            try
            {
                ...
                cmd.Parameters.AddWithValue("@EmployeeFirstName", baemployee.EmployeeFirstName);
                cmd.Parameters.AddWithValue("@EmployeeLastName", baemployee.EmployeeLastName);
                ...
                cmd.Parameters.AddWithValue("@EmpCity", baemployee.EmpCity);
                cmd.Parameters.AddWithValue("@EmpZipNo", baemployee.EmpZipNo);
                cmd.Parameters.AddWithValue("@EmpState", baemployee.EmpState);
                cmd.Parameters.AddWithValue("@EmpCountry", baemployee.EmpCountry);
